...
path = SvmSegm_paths();
system(sprintf([path.repos_path 'cpmc-master/external_code/globalPb/lib/segment -image %s -smatrixfile %s -readlattice true -latticefile %s -dthresh 5'], imgFile, simFile, latFile));
delete(latFile);
delete(imgFile);
