...
VOCopts.datadir=['D:\百度云\我的文档\Code\deeplearning\database\VOCdevkit' '/'];

% change this path to a writable directory for your results
VOCopts.resdir=['D:\百度云\我的文档\Code\deeplearning\database\VOCdevkit' '/results/' VOCopts.dataset '/'];

% change this path to a writable local directory for the example code
VOCopts.localdir=['D:\百度云\我的文档\Code\deeplearning\database\VOCdevkit' '/local/' VOCopts.dataset '/'];
